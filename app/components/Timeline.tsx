...
export default async function Timeline() {
  ...
  const combinedItems = [...posts, ...projects].sort(
    (a, b) =>
      new Date(b.firstPublishedDate || b.releaseDate).getTime() -
      new Date(a.firstPublishedDate || a.releaseDate).getTime()
  )
        ...
        ({
          ...
          <li key={_id} className="mb-10 ms-6">
            ...
            <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
              {new Date(firstPublishedDate || releaseDate).toLocaleDateString(
                'pt-BR',
                {
                  day: '2-digit',
                  month: '2-digit',
