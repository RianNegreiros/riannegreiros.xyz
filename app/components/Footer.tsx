...
export default function Footer() {
  return (
    <footer className="px-4 md:px-8 lg:px-10">
      ...
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <div className="px-4 py-6 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© {new Date().getFullYear()} <Link className='hover:underline' href="https://www.riannegreiros.dev/">riannegreiros.dev</Link>. Todos os direitos reservados.</span>
          <div className="flex sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            {RESUME_DATA.contact.social.map((social) => (
              <a href={social.url} key={social.name} className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
